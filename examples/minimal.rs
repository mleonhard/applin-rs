...
//! < set-cookie: session=15245242720001077840-2658341692125681199; HttpOnly; Max-Age=2592000; SameSite=Strict; Secure
//! <
//! data: {"/":["Hello"]}
//! ^C
//! ```
...
pub fn main() {
    ...
    let key_set_fn = move |_ctx: &Context<()>| {
        Ok(KeySet::new().with_static("/", Value::Array(vec![text("Hello")])))
    };
